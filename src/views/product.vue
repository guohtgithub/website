  ...
  <div>
    <div style="background:#191B31">
      ...
      <a-row :gutter='24' class="ptb-48 mg0 row-max" :class="!isPC?'pd-t-80':''">
        ...
        <a-col :xs='12' :sm='9' class='wow slideInLeft' style="padding-top:10px;">
          <h2>{{solutionTitle}}</h2>
      ...
      <div v-for="(item,index) in viewData" :key="item.title">
        ...
        <a-row :gutter='24' class="pd-48 solution mg0 wow slideInLeft"
          ...
          <a-col :xs=24 :sm='10' 
            ...
            v-show="!item.image"
          >
            <div class="bg-gray heigh-150 pd-30-50">
              <h2 class="font-color-orgine font-18">{{list.title}}</h2>
        ...
        <a-row :gutter='24' class="pd-48 solution mg0 wow slideInRight"
          ...
          >
            <div class="bg-gray height-350">
              ...
              <h2 class="font-color-gray center font-18">{{list.title}}</h2>
